...
public class FenetreAccueil extends JFrame {
	...
	public FenetreAccueil() {
		...
		JButton btnLouer = new JButton("Louer un scooter");
		...
		JButton btnRetourScooter = new JButton("Retour de scooter");
